...
* Goal: mirror the structure of objects of the API to support
...
parse_date_time(x = test_series$values$timestamp, orders = "OS")
...
`sensorweb4R` is open source software managed within the [52°North Sensor Web Community](http://52north.org/communities/sensorweb/). The code is available on GitHub: [https://github.com/52North/sensorweb4R](https://github.com/52North/sensorweb4R)
